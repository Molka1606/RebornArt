...
$liste = $commentC->fetchCommentaires(); // récupère tous les commentaires
?>
...
<head>
    ...
    <title>Back-office - Liste des commentaires</title>
            ...
            <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Commentaires disponibles</h6>
                    </div>
                    <div class="card-body">
                        <?php if(empty($liste)): ?>
                                        ...
                                        <?php foreach ($liste as $comment): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="../../controller/commentcontroller.php?action=delete&id=<?= $comment['id']; ?>&blog=<?= $comment['blog_id']; ?>"
